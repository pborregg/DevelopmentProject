...
You are to develop a Single Page Application, using your favorite front-end framework, according to the specifications listed below. You can take 1 hour to plan out your project, if desired, and 2 hours to develop. Once you have spent 2 hours on development, please email your results to the sbarney@xcite-interactive.com, along with instructions on how to build and run it. It is preferred that all submissions be able to be run using Node's npm or yarn tools.
